...
import { deliSection1Array } from './deliSection1Array'
...
const DeliSection1 = () => {
  return (
    ...
    <div className='text-lg sm:text-3xl md:text-3xl lg:text-3xl xl:text-3xl  font-bold pb-4'>Nourish Your Life,Simply</div>
    <div><div className='m-auto grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 w-full md:w-[98%] lg:w-[70%] xl:w-[45%] justify-center'>
      {deliSection1Array.map((product, index) => (
